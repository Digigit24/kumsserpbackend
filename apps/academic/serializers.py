...
class ClassTeacherSerializer(TenantAuditMixin, serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            'id', 'class_obj', 'class_name', 'section', 'section_name',
            'academic_session', 'teacher', 'teacher_details', 'assigned_from',
            'assigned_to', 'is_current', 'is_active',
            'created_by', 'updated_by', 'created_at', 'updated_at'
        ]
    ...
    def get_academic_session(self, obj):
        if obj.class_obj and obj.class_obj.academic_session:
            return {
                'id': obj.class_obj.academic_session.id,
                'name': obj.class_obj.academic_session.name
            }
        return None
