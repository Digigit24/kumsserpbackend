...
class UserManager(BaseUserManager):
    ...
    Handles user creation with college scoping support.
    """
    ...
    def teachers(self):
        ...
        return self.filter(user_type='teacher', is_active=True)

    def students(self):
        """Return student users."""
        return self.filter(user_type='student', is_active=True)
