...
class PurchaseOrder(AuditModel):
    ...
    def clean(self):
        ...
        if self.requirement and self.requirement.status not in ['approved', 'quotations_received', 'po_created']:
            raise ValidationError({
...
class GoodsReceiptNote(AuditModel):
    ...
    purchase_order = models.ForeignKey(PurchaseOrder, on_delete=models.CASCADE, related_name='goods_receipts', null=True, blank=True)
    supplier = models.ForeignKey(SupplierMaster, on_delete=models.PROTECT, related_name='goods_receipts', null=True, blank=True)
    central_store = models.ForeignKey(CentralStore, on_delete=models.CASCADE, related_name='goods_receipts', null=True, blank=True)
...
class GoodsReceiptItem(AuditModel):
    ...
    po_item = models.ForeignKey(PurchaseOrderItem, on_delete=models.CASCADE, related_name='grn_items', null=True, blank=True)
